...
### Added
- `Direction` type now exported from the main entry point
- `DIRECTION_HORIZONTAL` and `DIRECTION_VERTICAL` constants now exported from the main entry point
...
### Changed
- **numVisible Validation** - Throw error instead of console.warn when numVisible >= itemCount
...
- **npm Scripts** - `build`, `build:js`, `build:css`, `dev` commands
...
[1.3.0]: https://github.com/jonchretien/continuous-carousel/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/jonchretien/continuous-carousel/compare/v1.0.1...v1.2.0
